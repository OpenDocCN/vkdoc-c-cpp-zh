...
![$$ {z}_{n+1}=\kern0.5em {z}_n^2+c $$](img/A978-1-4842-0004-9_10_Chapter_TeX2GIF_IEq3.gif)，其中`c`为复数常数。c 的值决定了 Julia 集的形状。
...
![$$ a{x}^2+bx+c=0 $$](img/A978-1-4842-0004-9_10_Chapter_TeX2GIF_Equm.gif)
...
![$$ x=\frac{-b\pm \sqrt{b^2-4ac}}{4ac} $$](img/A978-1-4842-0004-9_10_Chapter_TeX2GIF_Equn.gif)